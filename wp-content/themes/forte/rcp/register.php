...
<form id="rcp_registration_form" class="rcp_form" method="POST" action="<?php echo esc_url( rcp_get_current_url() ); ?>">
	...
	<p id="rcp_submit_wrap">
		...
		<input type="submit" name="rcp_submit_registration" id="rcp_submit" class="btn" value="<?php echo apply_filters ( 'rcp_registration_register_button', __( 'Create your Account', 'rcp' ) ); ?>"/>
	</p>
</form>
...
<?php if (get_theme_mod('login_page_selector')) { ?>
	...
	<p class="rcp_text">
		<a href="<?php echo get_page_link(get_theme_mod('login_page_selector')); ?>"><?php _e( 'Already have an account? Login &rarr;', 'bean' ); ?></a>
	</p><!-- END .rcp_text -->
